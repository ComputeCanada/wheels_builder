...
PRE_BUILD_COMMANDS='
	...
	cmake -B _build -S . -DCMAKE_INSTALL_PREFIX=$PWD/INST -DOPENMP_RUNTIME=COMP -DWITH_CUDA=ON -DWITH_CUDNN=ON -DCUDA_ARCH_LIST="8.0 9.0" -DBLA_VENDOR=FlexiBLAS -DWITH_OPENBLAS=ON -DWITH_MKL=OFF -DCMAKE_INCLUDE_PATH=$EBROOTFLEXIBLAS/include/flexiblas -DCMAKE_LIBRARY_PATH=$EBROOTFLEXIBLAS/lib -DWITH_TENSOR_PARALLEL=ON -DENABLE_CPU_DISPATCH=ON -DWITH_RUY=ON &&
...
'
MODULE_BUILD_DEPS='openmpi cuda/12.9 cudnn nccl flexiblas'
