...
if [[ "$EBVERSIONGENTOO" == "2023" ]]; then
	MODULE_BUILD_DEPS="vtk/9 eigen clang cuda/12 protobuf flexiblas abseil"
else
...
PRE_BUILD_COMMANDS="
	...
	cmake -B _build -S . -DDEVELOPER_BUILD=OFF -DBUILD_EXAMPLES=OFF -DUSE_SYSTEM_VTK=ON -DUSE_SYSTEM_EIGEN3=ON \
	...
	cmake --build _build --config Release --parallel 16;
...
"
PATCHES="
	open3d-fix_platname.patch
	open3d-build_torch_ops.patch
"
