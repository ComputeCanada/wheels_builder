...
PRE_BUILD_COMMANDS="mkdir build && cd build && cmake .. -DCMAKE_CUDA_ARCHITECTURES='60;70;75;80;86;90' -DUSE_CUDA=ON -DUSE_NCCL=ON -DNCCL_ROOT=$EBROOTNCCL && make -j4 && cd ../python-package/"
