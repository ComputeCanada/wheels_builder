...
PRE_BUILD_COMMANDS='
	export VERBOSE=1;
	export CMAKE_CONFIGURE_ARGS="-DBLA_VENDOR=Flexiblas -DBLAS_LIBRARIES=-lflexiblas -DBUILD_MARCH_NATIVE=1 -DBUILD_LIBCINT=0 -DBUILD_LIBXC=0 -DUSE_QCINT=1 -DENABLE_FFTW=1 -DBUILD_FFTW=0 -DENABLE_SMD=ON"
'
