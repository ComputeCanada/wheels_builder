...
PYTHON_TESTS="scipy.__config__.show(); scipy.test(parallel=1, extra_argv=['--timeout=180', '--timeout-method=signal', '-k', 'not test_nan_values[slsqp] and not test_all_data_read_bad_checksum and not test_all_data_read_overlap'])"
