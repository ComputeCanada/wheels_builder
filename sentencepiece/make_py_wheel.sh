...
build_tf_wrapper() {
  ...
  virtualenv build_for_tensorflow${pkg_name}
  source build_for_tensorflow${pkg_name}/bin/activate
  ...
  g++ -std=c++11 -shared \
    ...
    -Wl,--whole-archive \
    ../../../sentencepiece/src/libsentencepiece.a \
    -Wl,--no-whole-archive \
...
#  build_tf_wrapper "1.14.0"
  ...
  virtualenv build_wheel
  source build_wheel/bin/activate
  pip install setuptools --upgrade
  pip install tensorflow_cpu --upgrade
